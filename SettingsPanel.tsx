...
export default function SettingsPanel() {
  ...
  const [registeredPasskeys] = useState([
    { id: '1', name: 'MacBook Pro - Touch ID', created: '2024-01-15', lastUsed: '2 hours ago' },
    { id: '2', name: 'iPhone 15 Pro - Face ID', created: '2024-01-10', lastUsed: '1 day ago' },
  ]);

  const [connectedProviders] = useState([
    { id: '1', name: 'Okta', status: 'connected', lastSync: '5 minutes ago' },
    { id: '2', name: 'Microsoft Entra ID', status: 'connected', lastSync: '1 hour ago' },
    { id: '3', name: 'Auth0', status: 'disconnected', lastSync: 'Never' },
  ]);
